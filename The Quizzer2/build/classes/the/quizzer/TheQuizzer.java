...
public class TheQuizzer extends JFrame implements ActionListener {

    JPanel panel, panelresult;
    JRadioButton choice1, choice2, choice3, choice4, choice5;
    ButtonGroup bg;
    JLabel lblmess;
    JButton btnext;
    String[][] qpa;
    ...
    void Quiz() {
        ...
        choice1.setFont(choice1.getFont().deriveFont(60.0f));
        choice2.setFont(choice2.getFont().deriveFont(60.0f));
        choice3.setFont(choice3.getFont().deriveFont(60.0f));
        choice4.setFont(choice4.getFont().deriveFont(60.0f));
        bg.add(choice1);
        bg.add(choice2);
        bg.add(choice3);
        bg.add(choice4);
        ...
        lblmess.setFont(new Font("Calibri", Font.BOLD, 40));
